#include "../../lib/Interface/QOpenCV2Widget.h"

// Constructor
QOpenCV2Widget::QOpenCV2Widget(QWidget *parent) : QWidget(parent) {
...
QOpenCV2Widget::~QOpenCV2Widget(void) {
    
}

void QOpenCV2Widget::putImage(IplImage *cvimage) {
        ...
        case IPL_DEPTH_8U:
            switch (cvimage->nChannels) {
                case 3:
					...
					/*image.scaled(QSize(200,200),Qt::KeepAspectRatio);
